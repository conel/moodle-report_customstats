...
<?php
				...
				echo "<p><img src=\"./images/go.gif\" alt=\"Online\" width=\"11\" height=\"11\" />&nbsp; <b>$online_users users online now</b> (users with activity in the past 5 minutes).</p>";
				...
				echo '<div class="graph"><img src="'.$CFG->wwwroot.'/report/stats/activitygraph.php?ts='.$timestamp.'" alt="Graph" width="750" height="400" /></div>';
